...
--any request specifications, and returns all of the requests made by the
--user specified in the WHERE clause, with the variable userId.
...
WHERE requests.users_id = :userId
